...
namespace JLokaTestGraphQL.Migrations
{
    ...
    [Migration("20260202063058_InitialMigrationWithAllModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Classroom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Equipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Furniture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.LabRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.TeacherCourse", b =>
                {
                    b.Property<Guid>("CourseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Course", b =>
                {
                    b.HasOne("JLokaTestGraphQL.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.Student", b =>
                {
                    b.HasOne("JLokaTestGraphQL.Models.Group", "Group")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.StudentCourse", b =>
                {
                    b.HasOne("JLokaTestGraphQL.Models.Course", null)
                        .WithMany("StudentCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JLokaTestGraphQL.Models.Student", null)
                        .WithMany("StudentCourses")
            ...
            modelBuilder.Entity("JLokaTestGraphQL.Models.TeacherCourse", b =>
                {
                    ...
                    b.HasOne("JLokaTestGraphQL.Models.Teacher", null)
                        .WithMany("TeacherCourses")
